...
write .harness-rules/claude/.claude/CLAUDE.md      blocks global lifecycle claude-pstack-models
# write .harness-rules/claude/.claude/CLAUDE.md      blocks global lifecycle
write .harness-rules/codex/AGENTS.override.md      blocks global lifecycle codex-pstack-models
# write .harness-rules/codex/AGENTS.md      blocks global lifecycle 
write .harness-rules/opencode/OPENCODE.md      blocks global lifecycle 
