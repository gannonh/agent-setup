...
judgment and prose: claude:claude-fable-5@xhigh
hardest tasks: claude:claude-fable-5@xhigh
how explorer: cursor:cursor-grok-4.6@xhigh
how explainer: claude:claude-fable-5@xhigh
how critics: claude:claude-fable-5@xhigh, codex:gpt-5.6-sol@xhigh, cursor:cursor-grok-4.6@xhigh, claude:claude-opus-5@xhigh
why investigators, synthesizer: inherit-parent
reflect tooling, judgment, divergent, synthesizer: inherit-parent
arena runners: claude:claude-fable-5@xhigh, codex:gpt-5.6-sol@xhigh, cursor:cursor-grok-4.6@xhigh, claude:claude-opus-5@xhigh
arena cross-judge pool: claude:claude-fable-5@xhigh, codex:gpt-5.6-sol@xhigh, cursor:cursor-grok-4.6@xhigh, claude:claude-opus-5@xhigh
swarm workers: cursor:cursor-grok-4.6@xhigh
architect runners: claude:claude-fable-5@xhigh, codex:gpt-5.6-sol@xhigh, cursor:cursor-grok-4.6@xhigh, claude:claude-opus-5@xhigh
interrogate reviewers: claude:claude-fable-5@xhigh, codex:gpt-5.6-sol@xhigh, cursor:cursor-grok-4.6@xhigh, claude:claude-opus-5@xhigh
<!-- pstack:models:end -->
